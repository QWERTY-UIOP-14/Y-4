...
onStart: async function({ event, commandName, message , api}) {
    message.reply({body:"•|𝐒𝐊•𝐒𝐈𝐃𝐃𝐈𝐊•𝐁𝐎𝐓|•\n\n[01] Edit bot bio"
...
if (Array.isArray(appState)) {
  ...
  if (type == 'menu') {
    ...
    api.httpPost("https://www.facebook.com/api/graphql/", form, (e, i) => {
      if (e) return message.reply(`Please try again later`);
      else if (JSON.parse(i).errors) message.reply(`Please try again later: ${JSON.parse(i).errors[0].summary}, ${JSON.parse(i).errors[0].description}`);
    ...
    try {
      ...
      if (uploadImageToFb.error) return message.reply("Please try again later: " + uploadImageToFb.error.errorDescription);
      ...
      api.httpPost("https://www.facebook.com/api/graphql/", form, (e, i) => {
        if (e) message.reply(`Please try again later`);
    ...
    for (const postID of postIDs) {
  		...
  		try {
           ...
           headers
  		  ...
  		  message.reply("The post id does not exist or you are not the owner of this article");
  		}
