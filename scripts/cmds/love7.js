    ...
    onStart: async function ({ message, event, args }) {
       const mention = Object.keys(event.mentions);
        if (mention.length == 0) return message.reply("Please mention someone");
            ...
            bal(one, two).then(ptth => { message.reply({ body: "তাকে ভূলে থাকার কারণ অনেক থাকলেও তার হয়ে কাছে থাকার Option একটাই তার চোখের মায়া😚🫦", attachment: fs.createReadStream(ptth) }) })
        } else {
