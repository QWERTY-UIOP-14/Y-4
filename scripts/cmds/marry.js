...
module.exports = {
    config: {
        ...
        aliases: ["marriage"],
        version: "1.0",
        author: "SIDDIK",//don't change credit otherwise I'm gonna fuck your mom
        countDown: 5,
        role: 0,
...
const one = event.senderID, two = mention[0];
                bal(one, two).then(ptth => { message.reply({ body: "🔰ₕₑᵣₑ ᵢₛ ᵢₘₐgᵢₙₐₜᵢₒₙ ₘₐᵣᵣᵢₑd🔰", attachment: fs.createReadStream(ptth) }) })
} else{
...
async function bal(one, two) {//credit siddik #_#
