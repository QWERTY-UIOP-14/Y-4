...
const botName = config.nickNameBot || "𝐒𝐊_𝐒𝐈𝐃𝐃𝐈𝐊_⓿❼"; // Fetching from config
...
const now = moment().tz(config.timeZone || 'Asia/Dhaka'); // Fetching from config
...
"https://i.imgur.com/5KuCPVq.jpeg"
];
